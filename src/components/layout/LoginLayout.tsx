...
import FooterAutentikasi from "../Element/footer/FooterAutentikasi"
  ...
  return (
    <div>
        <div className="mt-2 text-green-500 justify-center flex items-center">
            <TiShoppingCart className="w-[25px] h-[25px]"/>
            <BannerDaftarlayout text="BeliBeli.com"/>
        </div>
        ...
        <div className=" flex flex-col justify-center items-center">
            ...
            className="w-[300px]" />
            <p className="font-bold text-xl mt-7">Jual Beli Mudah Hanya di BeliBeli</p>
        ...
        <form method="" action={"/register"} >
            ...
            <MasukLayoutTyphography text1="Belum punya akun BeliBeli?" text2="daftar"/>
